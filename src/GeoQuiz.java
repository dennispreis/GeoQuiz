...
public class GeoQuiz extends PApplet
{
    ...
    private static UserDaoInterface IUserDao;
    ...
    {
        user = isTeacher ? IUserDao.createTeacherUser(ID) : IUserDao.createStudentUser(ID);
    }
    ...
    public void Login_Login()
    {
        ...
        int ID = IUserDao.getAccountId(name, password, isTeacher);
