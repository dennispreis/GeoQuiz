...
public class UIManager
{
    ...
    private void uielementsCreateAdminMainMenu()
    {
        controller.put(Screen.MAIN_MENU_ADMIN, new Controller[]
        {
            ...
            .setPosition(255, 420)
            .setSize(400, 50)
            .setLabel("View Student Progress").onClick(callbackEvent -> 
            {
                switchScreen(Screen.VIEW_STUDENT_PROGRESS_ADMIN);
            }),
            cp5.addButton("Main_Menu_Student_Logout")
            .setPosition(20, 20)
            .setSize(200, 50)
    ...
    private void uielementsCreateAdminView()
    {
        controller.put(Screen.VIEW_STUDENT_PROGRESS_ADMIN, new Controller[]
        {
        });
